<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"/www/wwwroot/game.com/application/admin/view/game/edit.tpl.php";i:1601311273;s:65:"/www/wwwroot/game.com/application/admin/view/public/toper.tpl.php";i:1530175630;s:66:"/www/wwwroot/game.com/application/admin/view/public/footer.tpl.php";i:1503323382;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
    ...
    <div class="layui-tab-content">
        <form class="layui-form">
            <div class="layui-tab-item layui-show">
                ...
                <?php echo Form::input('android_url',$game['android_url'],'安卓下载地址','安卓下载地址','以http://开头');//echo Form::radio('is_recommend',$game['is_recommend'],'是否推荐','用于前台推荐调用',array(1=>'是',0=>'否'));?>
                <?php echo Form::date('create_time',$game['create_time'],'添加时间','默认是当前时间');?>
                <?php echo Form::input('hits',$game['hits'],'载量','请输入数字','请输入下载量，单位万次','number');//echo Form::input('url',$game['url'],'链接地址','外链地址，非外链文章则留空','以http://开头');?>
    ...
    layui.use(['element', 'form'], function(){
        ...
        form.on('submit(game_edit)', function(data){
            ...
            $.ajax({
                type:'post',
                dataType:'json',
                url:'<?php echo url("game/edit"); ?>',
                data:param,
                success:function(data){
                    if(data.code == 200){
                        show_msg(data.msg,1,'<?php echo url("game/index",["category_id"=>$game["category_id"]]); ?>');
                    }else{
                        show_msg(data.msg,2);
                    }
                },
