...
class Game extends Init
{
    ...
    function index(){
        ...
        $games = $this->model->get_list($map,$order,$page_size);
        return view('list',['category_id'=>$category_id,'games'=>$games,'url_params_arr'=>$url_params_arr,'url_params_str'=>$url_params_str]);
    }
    ...
    function edit(){
        ...
        $game = $this->model->where('id',input('param.id'))->find();
        $model_category_select_option = $this->category_model->get_model_category_select_with_option($game['category_id']);
        return view('edit',array('game'=>$game,'model_category_select_option'=>$model_category_select_option));
    }
