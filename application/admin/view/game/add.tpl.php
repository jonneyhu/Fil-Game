    ...
    <div class="layui-tab-content">
        <form class="layui-form">
            <div class="layui-tab-item layui-show">
                ...
                <?php echo Form::input('android_url','','安卓下载地址','安卓下载地址','以http://开头');?>
                ...
                <?php echo Form::input('hits',0,'下载量','请输入数字','请输入下载量，单位万次','number');?>
        ...
        form.on('submit(game_add)', function(data){
            ...
            $.ajax({
                ...
                success:function(data){
                    if(data.code == 200){
                        show_msg(data.msg,1,'{:url("game/index",["category_id"=>$category_id])}');
                    }else{
                        show_msg(data.msg,2);
                    }
                },
